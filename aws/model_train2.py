...
save_best_model = ModelCheckpoint(filepath='2_model_.{epoch:02d}_{val_loss:.2f}.hdf5', verbose=1,
        monitor='val_loss')
...
fp = open('2_train_data.dat','w')
fp.write(res)
fp.close()

# Save model
model.save_weights('2_full_model_weights.h5')
