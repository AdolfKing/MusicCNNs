...
save_best_model = ModelCheckpoint(filepath='mlp_topk_model_.{epoch:02d}_{val_loss:.2f}.hdf5', verbose=1,
        monitor='val_loss')
...
fp = open('mlp_topk_train_data.dat','w')
fp.write(res)
fp.close()

# Save model
model.save_weights('mlp_topk_full_model_weights.h5')
model.save('mlp_topk_model.h5')
